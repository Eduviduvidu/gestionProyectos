...
class Tarea extends \gestionProyectos\mainBundle\Entity\Tarea implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Tarea' . "\0" . 'id', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Tarea' . "\0" . 'nombre', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Tarea' . "\0" . 'descripcion', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Tarea' . "\0" . 'fechainicio', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Tarea' . "\0" . 'fechafinal', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Tarea' . "\0" . 'status'];
        }
