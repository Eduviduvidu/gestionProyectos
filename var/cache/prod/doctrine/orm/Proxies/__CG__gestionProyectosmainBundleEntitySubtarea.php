 ...
 */
class Subtarea extends \gestionProyectos\mainBundle\Entity\Subtarea implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Subtarea' . "\0" . 'id', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Subtarea' . "\0" . 'nombre', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Subtarea' . "\0" . 'contenido', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Subtarea' . "\0" . 'fechainicio', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Subtarea' . "\0" . 'fechafinal', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Subtarea' . "\0" . 'status', '' . "\0" . 'gestionProyectos\\mainBundle\\Entity\\Subtarea' . "\0" . 'idTarea'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Subtarea $proxy) {
    ...
    public function setIdTarea(\gestionProyectos\mainBundle\Entity\Tarea $idTarea = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdTarea', [$idTarea]);
    ...
    public function getIdTarea()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdTarea', []);
